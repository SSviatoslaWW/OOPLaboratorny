...
{
    internal class ComplexNumber : MyString, IComparable<ComplexNumber>, ICloneable
    {
        ...
        {
            if (ReferenceEquals(firstNumber, null) || ReferenceEquals(secondNumber, null))
            {
                return ReferenceEquals(firstNumber, secondNumber);
            }
        ...
        {
            return this.moduleComplexNumber().CompareTo(other.moduleComplexNumber());
        }

        new public object Clone()
        {
            return new ComplexNumber(this.MyStringWithChar);
        }
    }
}
